...
#### Scenario: Settings and menu do not expose auto-fit
- Given the user opens the Settings surface or the View menu
- When they inspect fit-related controls
- Then only the manual Fit action is available
